            ...
            <View className='p-2 bg-white rounded-t-3xl h-full'>
                <Card className="border border-white rounded-lg mb-2 bg-gray-50 p-2 shadow-md shadow-black m-2">
                    <CardHeader className='mb-4 gap-2'>
                        <Text className='text-xl font-bold text-gray-700'>Abertura: <Text className='font-normal text-gray-500'>{details.Abertura}</Text></Text>
                        <Text className='text-xl font-bold text-gray-700'>Defeito: <Text className='font-normal text-gray-500'>{details.defeito}</Text></Text>
                        <Text className='text-xl font-bold text-gray-700'>Status: <Text className='font-normal text-gray-500'>{details.status}</Text></Text>
                    </CardHeader>
                </Card>
                <Card className="border border-white rounded-lg mb-2 bg-gray-50 p-2 shadow-md shadow-black m-2">
                    <View
                                    ...
                                    (e: any, i: number, row: any) => (
                                        ...
                                        >
                                            ...
                                            <Text
                                                ...
                                                className="text-sm font-medium text-solar-blue-secondary ml-2"
                                            >
                                                {e?.xEventos}
                                            </Text>
                                        </View>
