          ...
          <View>
            ...
            <View className='p-4 bg-white rounded-t-3xl'>
              ...
              <View className='flex-col gap-4 my-4'>
                ...
                />
                {errors.nomeCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.nomeCliente?.message}</Text>
                )}
                ...
                {errors.enderecoCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.enderecoCliente?.message}</Text>
                )}
                ...
                />
                {errors.cepCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.cepCliente?.message}</Text>
                )}
                ...
                />
                {errors.ufCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.ufCliente?.message}</Text>
                )}
                ...
                {errors.cidadeCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.cidadeCliente?.message}</Text>
                )}
                ...
                {errors.celularCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.celularCliente?.message}</Text>
                )}
                ...
                />
                {errors.emailCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.emailCliente?.message}</Text>
                )}
                ...
                {errors.nascimentoCliente && (
                  <Text className='text-solar-red-primary -mt-4'>{errors.nascimentoCliente?.message}</Text>
                )}
              </View>
