...
const DataAnalise = () => {
    ...
    return (
        <View className='bg-solar-blue-primary flex-1'>
            <ScreenHeader title="Remoção de dados" subtitle="Nossa equipe proceguirá com o processo para a exclusão de dados" classTitle='text-white text-2xl' classSubtitle='text-white text-base text-center' />
