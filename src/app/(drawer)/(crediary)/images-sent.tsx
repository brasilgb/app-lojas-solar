            ...
            <View className='p-4 bg-gray-100 rounded-t-3xl h-full'>
                ...
                <View className='flex-col justify-between flex-1'>
                    <View className='gap-8'>
                        <View>
                            <Text className='text-3xl font-semibold text-center text-solar-blue-secondary'>Obrigado por registrar-se e solicitar o crediário das Lojas Solar</Text>
                        </View>
                    ...
                    <View>
                        <Button
                            onPress={() => router.replace('/(drawer)/(crediary)')}
