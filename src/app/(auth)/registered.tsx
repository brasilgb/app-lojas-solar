      ...
      <View className='p-4 bg-gray-100 rounded-t-3xl h-full'>
        ...
        <View className='flex-col justify-between flex-1'>
          <View className='gap-8'>
            <View>
              <Text className='text-3xl font-semibold text-center text-solar-blue-secondary'>Cadastro efetuado com sucesso</Text>
            </View>
            <Text className='text-xl px-10 text-center text-gray-600'>
              Agora só falta criar uma senha para obter acesso a todas as facilidades do aplicativo.
            </Text>
          </View>
          <View>
            <Button
