      ...
      <View className='p-4 bg-gray-100 rounded-t-3xl h-full'>
        ...
        <View className='flex-col justify-between flex-1'>
          <View className='gap-8'>
            <View>
              <Text className='text-3xl font-semibold text-center text-solar-blue-secondary'>Você ainda não possui um cadastro nas lojas solar.</Text>
            </View>
            <Text className='text-xl px-10 text-center text-gray-600'>
              Você poderá efetuar seu cadastro aqui, e ter em sua mão todas as facilidades através de nosso aplicativo.
            </Text>
          </View>
          <View>
            <Button
