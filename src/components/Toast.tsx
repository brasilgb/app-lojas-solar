...
const toastVariants = {
  ...
  destructive: 'bg-solar-red-primary',
  warning: 'bg-solar-yellow-primary',
  success: 'bg-solar-green-primary',
  info: 'bg-solar-blue-primary',
};
...
function Toast({
  ...
  return (
    ...
    >
      <Text className="font-semibold text-left text-white">{message}</Text>
      {showProgress && (
