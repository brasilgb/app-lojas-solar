...
import { Card, CardTitle, CardContent, CardFooter, CardHeader } from '@/components/Card';
  ...
  return (
    ...
    >
      <View className='flex-1 bg-black/30 justify-center items-center'>
        <Card className='m-5 bg-white rounded-2xl !border-2 border-gray-100 px-2 w-4/5' style={styles.modalView}>
          ...
          <CardFooter className='flex-row justify-center'>
            <Button label="Fechar" variant="default" size="default" onPress={onClose} />
          </CardFooter>
        </Card>
      </View>
    </Modal>
